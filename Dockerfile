...
RUN apt-get update \
    && apt-get -y install apt-utils ffmpeg curl software-properties-common apt-transport-https ca-certificates wget dirmngr gnupg iproute2 libopus0 make g++ locales git ffmpeg cmake zip unzip libtool-bin
